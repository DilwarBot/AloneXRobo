...
────「 [Daisy Robot](https://telegra.ph/file/a9814904340a6f4a994eb.jpg) 」────
ʜᴇʏ! {}
...
buttons = [
    [
        InlineKeyboardButton(
            text="🥀 Add To Your Group 🥀", url="t.me/DaisyXRobot?startgroup=new"),
    ],
    [                  
                       InlineKeyboardButton(
                             text="Support🔥",
                             url=f"https://t.me/The_Alone_Network"),
                       InlineKeyboardButton(
                             text="Updates📣",
                             url=f"https://t.me/The_Alone_Network"),
    ],
